# HL7® AT Core Patient Profile - v0.5.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gabriel0316.github.io/ig-tooling-pages/ig/ig-tooling-test/StructureDefinition/at-core-patient | *Version*:0.5.3 |
| Draft as of 2025-10-22 | *Computable Name*:HL7ATCorePatient |
...
```json
{
  ...
  "id" : "at-core-patient",
  "url" : "https://gabriel0316.github.io/ig-tooling-pages/ig/ig-tooling-test/StructureDefinition/at-core-patient",
  "version" : "0.5.3",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "fixedUri" : "http://hl7.at/fhir/HL7ATCoreProfiles/4.0.1/CodeSystem/at-core-cs-iso-3166-1-alpha-3"
      },
      {
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gabriel0316.github.io/ig-tooling-pages/ig/ig-tooling-test/StructureDefinition/at-core-ext-patient-religion"
            ]
          }
        ]
      },
      ...
      {
        "id" : "Patient.identifier:socialSecurityNumber.type.coding.display",
      ...
      {
        "id" : "Patient.identifier:bPK.type.coding.display",
        "path" : "Patient.identifier.type.coding.display",
        "fixedString" : "National unique individual identifier"
      },
      {
      ...
      {
        "id" : "Patient.identifier:localPatientId.type.coding.display",
        "path" : "Patient.identifier.type.coding.display",
        "fixedString" : "Patient internal identifier"
      },
      {
        ...
        "type" : [
          {
            "code" : "Address",
            "profile" : [
              "https://gabriel0316.github.io/ig-tooling-pages/ig/ig-tooling-test/StructureDefinition/at-core-address"
            ]
          }
        ]
      },
